...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/iosbackup-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14052&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/iosbackup-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `iosbackup` can be installed with:

```
conda install iosbackup
```

It is possible to list all of the versions of `iosbackup` available on your platform with:
